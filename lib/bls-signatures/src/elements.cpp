...
{
    std::cout << "获取plot_key ->>> operator+" << std::endl;
    G1Element ans;
    std::cout << "bytesA:" << bls::Util::HexStr(a.Serialize()) << std::endl;
    std::cout << "bytesA-p:" << a.p << std::endl;
    std::cout << "bytesB:" << bls::Util::HexStr(b.Serialize()) << std::endl;
    std::cout << "bytesB-p:" << b.p << std::endl;
    std::cout << "bytesAns:" << bls::Util::HexStr(ans.Serialize()) << std::endl;
    std::cout << "bytesAns-p:" << ans.p << std::endl;
